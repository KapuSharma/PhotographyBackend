...
-- CreateIndex
CREATE UNIQUE INDEX "HoiLead_clientId_source_sourceLeadId_key" ON "HoiLead"("clientId", "source", "sourceLeadId");

-- CreateIndex
CREATE INDEX "HoiLead_clientId_status_idx" ON "HoiLead"("clientId", "status");

-- CreateIndex
CREATE INDEX "HoiLead_clientId_source_idx" ON "HoiLead"("clientId", "source");
